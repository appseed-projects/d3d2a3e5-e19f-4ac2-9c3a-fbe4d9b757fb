...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-29 17:29`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/d3d2a3e5-e19f-4ac2-9c3a-fbe4d9b757fb.git
$ cd d3d2a3e5-e19f-4ac2-9c3a-fbe4d9b757fb
```
